...
object DatabaseSeeder {
    ...
    val defaultSellers = listOf(
        SellerProfileEntity(
            ...
            artisanStory = "Shanti Devi learned traditional bamboo weaving from her grandmother in the forested hills of Banswara. Through Padharo, her self-help group now ships directly to urban homes without city middlemen.",
            status = "APPROVED",
            isPro = true,
            rating = 4.9f,
            reviewCount = 28
        ...
        SellerProfileEntity(
            ...
            artisanStory = "Carrying forward the 150-year royal blue pottery tradition of Maharaja Sawai Ram Singh II with non-toxic lead-free natural glazes.",
            status = "APPROVED",
            isPro = false,
            rating = 4.8f,
            reviewCount = 42
        ...
        SellerProfileEntity(
            ...
            artisanStory = "Every Ajrakh pattern carries geometric celestial astronomy motifs handed down over 400 years across Thar desert communities.",
            status = "APPROVED",
            isPro = true,
            rating = 4.9f,
            reviewCount = 35
        ...
        SellerProfileEntity(
            ...
            artisanStory = "Creating heirloom timber pieces inspired by Mehrangarh Fort's intricate filigree woodwork.",
            status = "APPROVED",
            isPro = false,
            rating = 4.9f,
            reviewCount = 22
